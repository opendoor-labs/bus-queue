...
//    waker: Waker<AtomicArc<thread::Thread>>,
//}
//
...
//            sleeper.get().as_ref().unwrap().unpark();
//        }
//    }
//}
//
//impl<T: Send> fmt::Debug for Publisher<T> {
...
//                }
//            }
//            self.sleeper.sleeper.set(Some(thread::current()));
//            thread::park();
//        }
//    }
...
//}
//
//impl<T: Send> fmt::Debug for Subscriber<T> {
//    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
//        write!(f, "debug")
//    }
//}
...
//    fn clone(&self) -> Self {
//        let arc_t = Arc::new(AtomicArc::new( Some(thread::current())));
